...
export default class extends React.Component {
  ...
  createMarker() {
    ...
    const map = mapHolderRef && mapHolderRef.props && mapHolderRef.props.map;
    return new GeolocationMarker(map, this.markerOptions(), this.circleOptions());
  }
